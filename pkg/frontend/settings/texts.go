...
const (
	...
	FormatUserInfo = "Logged as: #bold class='primary-text'#%s##bold# #break###break#E-mail: #bold class='primary-text'#%s##bold#"
	...
	InfoUIMode           = "#bold class='blue-text'#The UI mode##bold# can be adjusted according to the user's choice. The setting will be applied to all devices connected via your account.#break###break# #break###break# #bold class='blue-text'#UI theme##bold# is a color scheme that is used to render this application for you."
	...
	InfoSubscribedDevice = "#bold#%s##bold##break###break# #break###break#Subsctibed to: %v#break###break#Registered: %s"
)
