...
const (
	...
	ERR_INVALID_REPLY      = "No valid response content was entered!"
	...
	ERR_CANNOT_REACH_BE = "I can't connect to the server!"
	ERR_CANNOT_GET_DATA = "I can't get the data!"
	...
	ERR_LOCAL_STORAGE_USER_FAIL = "I can't save user data to the browser, local storage failed!"
	...
	MSG_RESET_PASSPHRASE_SUCCESS = "Your passphrase has been changed, check your email inbox."
	...
	ERR_RESET_UUID_FIELD_EMPTY   = "A UUID string is required to continue, please check your inbox!"
	...
	MSG_LOCAL_TIME_TOGGLE        = "Local time mode switched."
	MSG_PRIVATE_MODE_TOGGLE      = "Private mode switched."
	...
	ERR_WEBSITE_REGEXP_FAIL      = "Failed to check the website format (regular expression object failed)!"
